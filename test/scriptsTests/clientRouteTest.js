...
describe('Client Routes', () => {
  ...
  describe('Rout POST /client/create', () => {
    it('should CREATE a client', done => {
      request.post('/client/create').set('Content-Type', 'application/json').send(defaultClient).end((err, res) => {
        if (err) done(err);
  ...
  describe('Rout PUT /client/update', () => {
    it('should UPDATE a client', done => {
      request.put('/client/update').send({
        name: clientUpdated,
  ...
  describe('Rout DELETE /client/remove', () => {
    it('should REMOVE a client', done => {
      request.delete('/client/remove').query({ name: clientUpdated }).end((err, res) => {
        if (err) done(err);
